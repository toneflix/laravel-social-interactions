    ...
    public function boot()
    {
        ...
        if ($this->app->runningInConsole()) {
            ...
            if ($this->unmigrated('update_social_interaction_saves_table_add_list_id')) {
                $this->publishes([
                    __DIR__ . '/../database/migrations/2024_07_10_215210_update_social_interaction_saves_table_add_list_id.php' => database_path('migrations/' . date('Y_m_d_His', time()) . '_update_social_interaction_saves_table_add_list_id.php'),
                ], 'social-interactions-migrations');
            }
        }
    }
