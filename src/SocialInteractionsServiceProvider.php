...
class SocialInteractionsServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        if ($this->app->runningInConsole()) {
            ...
            if ($this->unmigrated('add_list_id_to_social_interaction_saves_table')) {
                $this->publishes([
                    __DIR__ . '/../database/migrations/2024_07_10_215210_add_list_id_to_social_interaction_saves_table.php' => database_path('migrations/' . date('Y_m_d_His', time()) . '_add_list_id_to_social_interaction_saves_table.php'),
                ], 'social-interactions-migrations');
            }
        }
    }
